...
export default function Review() {
  ...
  return (
    <Screen>
      ...
      <Card>
        <Text style={{ color: theme.text, fontWeight: '700', textAlign: 'right' }}>الخدمة</Text>
      ...
      <Card>
        <Text style={{ color: theme.text, fontWeight: '700', textAlign: 'right' }}>المركبة</Text>
        <Text style={{ color: theme.muted, textAlign: 'right' }}>
      ...
      <Card>
        <Text style={{ color: theme.text, fontWeight: '700', textAlign: 'right' }}>التفاصيل</Text>
