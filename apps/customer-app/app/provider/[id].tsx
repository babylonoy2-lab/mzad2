...
import { Button, Card, Header, Icon, Screen, Stars, Title } from '../../src/components/ui';
...
export default function ProviderProfile() {
  ...
  return (
    <Screen>
      ...
      <Icon name="storefront-outline" size={48} color={theme.primary} />
      ...
      <Card>
        <Icon name="image-multiple-outline" size={34} color={theme.muted} />
        <Text style={{ color: theme.muted, textAlign: 'center' }}>
